...
handler.get(async (req, res) => {
  ...
  const cards = pool.query('SELECT * FROM cards WHERE board_id = $1;', [boardId]);
...
handler.post(async (req, res) => {
  ...
  let newCard = pool.query('INSERT INTO cards (title, description, priority, type, sequence, board_id, column_id, user_id) VALUES ($1, $2, $3, $4) RETURNING *;', [title, description, priority, type, sequence, boardId, columnId, id]);
