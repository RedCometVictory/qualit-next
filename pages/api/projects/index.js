...
handler.post(async (req, res) => {
  ...
  if (role === 'Admin') {
    newProject = pool.query('INSERT INTO projects (title, description, github_url, site_url, owner) VALUES ($1, $2, $3, $4, $5) RETURNING *;', [title, description, github_url, site_url, id]);
  };
