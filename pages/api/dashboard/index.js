...
handler.get(async (req, res) => {
  ...
  if (role === 'Project Manager') {
    ...
    // ); // ----
      // TODO: loop through all project ids from myProjects, then collect all tickets with matching project_ids, thus collecting all tickets belonging to every project assigned to as manager
